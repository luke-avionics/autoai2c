...
rf_noc_template=[ \
                 ...
                 ['batch_rf', 'row_kernel_rf', 'col_kernel_rf', 'ch_out_rf', 'ch_in_rf', 'col_out_rf', 'ref_rf_out', 'row_out_rf', 'ref_rf_we', 'ref_rf_in', 'col_kernel_noc', 'ch_in_noc', 'col_out_noc', 'ch_out_noc'], \
                 ['row_kernel_rf', 'batch_rf', 'ch_in_rf', 'ch_out_rf', 'col_kernel_rf', 'ref_rf_out', 'col_out_rf', 'ref_rf_in', 'row_out_rf', 'ref_rf_we', 'col_kernel_noc', 'row_kernel_noc', 'ch_in_noc', 'ch_out_noc'], \
                 ['row_kernel_rf', 'ch_in_rf', 'ch_out_rf', 'col_out_rf', 'col_kernel_rf', 'ref_rf_in', 'ref_rf_out', 'row_out_rf', 'batch_rf', 'ref_rf_we', 'col_kernel_noc', 'row_kernel_noc', 'ch_in_noc', 'ch_out_noc'], \
]
rf_noc_template=[ \
                 ['col_out_rf', 'batch_rf', 'row_out_rf', 'ref_rf_we', 'ch_out_rf', 'row_kernel_rf', 'ref_rf_in', 'ch_in_rf', 'ref_rf_out', 'col_kernel_rf', 'row_out_noc', 'col_out_noc', 'ch_out_noc'], \
                 ['ch_in_rf', 'ch_out_rf', 'row_kernel_rf', 'ref_rf_out', 'row_out_rf', 'ref_rf_in', 'batch_rf', 'col_kernel_rf', 'col_out_rf', 'ref_rf_we', 'col_kernel_noc', 'row_kernel_noc', 'ch_in_noc', 'ch_out_noc'], \
                 ['batch_rf', 'col_kernel_rf', 'row_out_rf', 'col_out_rf', 'ref_rf_we', 'row_kernel_rf', 'ch_out_rf', 'ch_in_rf', 'ref_rf_out', 'ref_rf_in', 'row_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
                 ['ch_out_rf', 'row_kernel_rf', 'ref_rf_out', 'ref_rf_in', 'col_out_rf', 'batch_rf', 'row_out_rf', 'ref_rf_we', 'col_kernel_rf', 'ch_in_rf', 'col_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
...
#rf_noc_template=[
                ['ch_out_rf', 'row_kernel_rf', 'col_out_rf', 'col_kernel_rf', 'ref_rf_out', 'ref_rf_in', 'row_out_rf', 'ref_rf_we', 'ch_in_rf', 'batch_rf', 'col_kernel_noc', 'row_kernel_noc', 'ch_in_noc', 'ch_out_noc'], \
                ['col_kernel_rf', 'row_kernel_rf', 'row_out_rf', 'col_out_rf', 'batch_rf', 'ref_rf_we', 'ch_out_rf', 'ref_rf_in', 'ch_in_rf', 'ref_rf_out', 'row_out_noc', 'col_out_noc', 'ch_out_noc'], \
                ['col_out_rf', 'batch_rf', 'col_kernel_rf', 'row_kernel_rf', 'ref_rf_we', 'ref_rf_in', 'ch_in_rf', 'row_out_rf', 'ch_out_rf', 'ref_rf_out', 'row_out_noc', 'col_out_noc', 'ch_out_noc'], \
                ['col_out_rf', 'col_kernel_rf', 'batch_rf', 'row_kernel_rf', 'ch_out_rf', 'ref_rf_we', 'row_out_rf', 'ref_rf_in', 'ch_in_rf', 'ref_rf_out', 'row_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
                ['col_kernel_rf', 'row_kernel_rf', 'col_out_rf', 'row_out_rf', 'ref_rf_we', 'ch_out_rf', 'ref_rf_in', 'batch_rf', 'ch_in_rf', 'ref_rf_out', 'row_out_noc', 'col_out_noc', 'ch_out_noc'], \
]
...
rf_noc_template=[ \
                 ...
                 ['ch_out_rf', 'row_kernel_rf', 'ref_rf_out', 'ref_rf_in', 'col_out_rf', 'batch_rf', 'row_out_rf', 'ref_rf_we', 'col_kernel_rf', 'ch_in_rf', 'col_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
                 ['row_out_rf', 'col_kernel_rf', 'ch_out_rf', 'batch_rf', 'col_out_rf', 'ref_rf_we', 'ref_rf_in', 'ch_in_rf', 'row_kernel_rf', 'ref_rf_out', 'row_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
                 ['row_kernel_rf', 'col_kernel_rf', 'batch_rf', 'col_out_rf', 'row_out_rf', 'ref_rf_out', 'ref_rf_we', 'ch_out_rf', 'ch_in_rf', 'ref_rf_in', 'row_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
                 ['ch_out_rf', 'row_out_rf', 'ch_in_rf', 'row_kernel_rf', 'ref_rf_in', 'ref_rf_out', 'batch_rf', 'col_out_rf', 'col_kernel_rf', 'ref_rf_we', 'col_kernel_noc', 'ch_in_noc', 'col_out_noc', 'ch_out_noc'], \
                 ['batch_rf', 'row_out_rf', 'col_out_rf', 'row_kernel_rf', 'ch_out_rf', 'ref_rf_in', 'col_kernel_rf', 'ref_rf_we', 'ch_in_rf', 'ref_rf_out', 'col_kernel_noc', 'ch_in_noc', 'col_out_noc', 'ch_out_noc'], \
                 ['row_out_rf', 'col_out_rf', 'col_kernel_rf', 'ref_rf_we', 'ch_out_rf', 'ref_rf_in', 'batch_rf', 'ch_in_rf', 'row_kernel_rf', 'ref_rf_out', 'row_out_noc', 'col_out_noc', 'ch_out_noc'], \

                 ['row_kernel_rf', 'col_out_rf', 'col_kernel_rf', 'ref_rf_out', 'batch_rf', 'ch_out_rf', 'row_out_rf', 'ref_rf_we', 'ref_rf_in', 'ch_in_rf', 'row_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
]
...
rf_noc_template=[
                ...
                ['batch_rf', 'row_out_rf', 'row_kernel_rf', 'col_kernel_rf', 'ref_rf_we', 'col_out_rf', 'ch_out_rf', 'ref_rf_in', 'ch_in_rf', 'ref_rf_out', 'col_kernel_noc', 'ch_in_noc', 'col_out_noc', 'ch_out_noc'], \
                ['batch_rf', 'row_kernel_rf', 'ch_out_rf', 'ref_rf_we', 'row_out_rf', 'ch_in_rf', 'col_out_rf', 'ref_rf_out', 'col_kernel_rf', 'ref_rf_in', 'col_kernel_noc', 'row_kernel_noc', 'ch_in_noc', 'ch_out_noc'], \
                ['col_kernel_rf', 'ch_in_rf', 'row_kernel_rf', 'ref_rf_we', 'ch_out_rf', 'ref_rf_in', 'batch_rf', 'col_out_rf', 'row_out_rf', 'ref_rf_out', 'col_kernel_noc', 'row_kernel_noc', 'ch_in_noc', 'ch_out_noc'], \
                ['col_out_rf', 'ch_out_rf', 'ch_in_rf', 'col_kernel_rf', 'ref_rf_in', 'batch_rf', 'ref_rf_out', 'ref_rf_we', 'row_kernel_rf', 'row_out_rf', 'col_kernel_noc', 'ch_in_noc', 'col_out_noc', 'ch_out_noc'], \
                ['col_kernel_rf', 'row_out_rf', 'row_kernel_rf', 'ch_out_rf', 'ref_rf_out', 'ref_rf_in', 'ch_in_rf', 'col_out_rf', 'batch_rf', 'ref_rf_we', 'row_kernel_noc', 'ch_in_noc', 'row_out_noc', 'ch_out_noc'], \
                 ['batch_rf', 'row_kernel_rf', 'ch_out_rf', 'col_kernel_rf', 'col_out_rf', 'ref_rf_in', 'ref_rf_we', 'ch_in_rf', 'row_out_rf', 'ref_rf_out', 'row_out_noc', 'col_out_noc', 'ch_out_noc'], \
                 ['batch_rf', 'row_kernel_rf', 'col_kernel_rf', 'ch_out_rf', 'ch_in_rf', 'col_out_rf', 'ref_rf_out', 'row_out_rf', 'ref_rf_we', 'ref_rf_in', 'col_kernel_noc', 'ch_in_noc', 'col_out_noc', 'ch_out_noc'], \
                 ['row_kernel_rf', 'batch_rf', 'ch_in_rf', 'ch_out_rf', 'col_kernel_rf', 'ref_rf_out', 'col_out_rf', 'ref_rf_in', 'row_out_rf', 'ref_rf_we', 'col_kernel_noc', 'row_kernel_noc', 'ch_in_noc', 'ch_out_noc'], \
